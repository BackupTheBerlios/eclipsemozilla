...
class MozillaBrowserListener implements ProgressListener, LocationListener,
		StatusTextListener, nsIDOMEventListener {
	...
	public void changed(LocationEvent event) {
		...
		if (event.top) {
			...
			nsIDOMWindow window = ((nsIWebBrowser) this.mozBrowserEditor.browser
			...
			this.mozBrowserEditor.setTitleToolTip(this.mozBrowserEditor.browser
					.getUrl());
	...
	public void completed(ProgressEvent event) {
		...
		if (event.widget instanceof Browser) {
			...
			this.mozBrowserEditor.backAction
					.setEnabled(this.mozBrowserEditor.browser.isBackEnabled());
			this.mozBrowserEditor.forwardAction
					.setEnabled(this.mozBrowserEditor.browser
							.isForwardEnabled());
	...
	public void handleEvent(nsIDOMEvent event) {
		...
		if ("pageshow".equals(eventType)
			...
			nsIDOMWindow topWindow = ((nsIWebBrowser) this.mozBrowserEditor.browser
					.getWebBrowser()).getContentDOMWindow();
